...
_Auto-generated by `.agents/scripts/sync-skills.sh` on 2026-06-27. Do not edit by hand._

63 skills available in this repo. Invoke as `/<command>` (Claude Code / Codex), or read the skill's `SKILL.md` directly in any agent.
