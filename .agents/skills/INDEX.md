...
_Auto-generated by `.agents/scripts/sync-skills.sh` on 2026-08-08. Do not edit by hand._

78 skills available in this repo. Invoke as `/<command>` (Claude Code / Codex), or read the skill's `SKILL.md` directly in any agent.
...
| `/behavior-test` | Behaviorally test whether agent-facing instructions (AGENTS.md rules, skill text, script banners) actually change agent behavior — stage a fixture repo, plant a real defect, and grade an uncontaminated probe agent on what it does. |
...
| `/kw:work` | Execute a knowledge work plan. Break it into tasks, do the work, and track what happened. |
...
| `/marketing-council` | When the user wants multiple expert perspectives on a marketing question — a simulated board of advisors staffed by legendary marketers (Seth Godin, David Ogilvy, Eugene Schwartz, April Dunford, Rory Sutherland, Alex Hormozi, Byron Sharp... |
