...
74 skills available in this repo. Invoke as `/<command>` (Claude Code / Codex), or read the skill's `SKILL.md` directly in any agent.
...
| `/behavior-probe` | Behaviorally test whether agent-facing instructions (AGENTS.md rules, skill text, script banners) actually change agent behavior — stage a fixture repo, plant a real defect, and grade an uncontaminated probe agent on what it does. |
