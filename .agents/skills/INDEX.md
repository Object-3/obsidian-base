...
| `/update-base` | Pull the latest base-layer improvements (skills engine, scripts, AGENTS.md, hooks) from the upstream base vault into this vault, without touching the user's notes or vault profile. |
