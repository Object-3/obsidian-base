...
_Auto-generated by `.agents/scripts/sync-skills.sh` on 2026-07-21. Do not edit by hand._

75 skills available in this repo. Invoke as `/<command>` (Claude Code / Codex), or read the skill's `SKILL.md` directly in any agent.
...
| `/add-engineering-skills` | Add the software-ENGINEERING (coding) skill set — EveryInc's Compound Engineering plugin (ce-*) — to this vault, as an opt-in. |
