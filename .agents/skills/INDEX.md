...
72 skills available in this repo. Invoke as `/<command>` (Claude Code / Codex), or read the skill's `SKILL.md` directly in any agent.
...
| `/vault-dream` | Consolidate this Obsidian knowledge base and fold durable learnings from recent agent sessions into it — a single "dream" pass that reads session transcripts since a watermark, captures reusable learnings into docs/knowledge/, dedupes/me... |
